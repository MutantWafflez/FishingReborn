...
namespace FishingReborn.Common.CustomCatchRules.Pools {
    /// <summary>
    /// Catch pool that has catches pertaining to the desert, or technically,
    /// an oasis.
    /// </summary>
    public class DesertCatchPool : ICatchPool {
        ...
        public bool IsPoolActive(FishingAttempt attempt, Projectile bobber) => Main.player[bobber.owner].ZoneDesert;
    }
}